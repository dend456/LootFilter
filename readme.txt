Extract files anywhere, run LootFilter.exe after starting the game. It may take a minute to complete.

By default it will use the endgame_items.txt filter file which filters ~99% of the items in the game so
